            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-6 bg-white pt-5 pt-5 pb-lg-0 pb-5">
                    <div class="sign-in-from">
                        ...
                        <form  action="sign-up.jsp" method="post" class="mt-4">
                            <div  class="form-group">
                                ...
                                <input name="username" type="text" class="form-control mb-0" id="exampleInputEmail1" placeholder="Your Full Name" required>
                                ...
                                <input  name="password" type="password" class="form-control mb-0" id="exampleInputPassword1" placeholder="Password" required>
                                 ...
                                 <button type="submit" class="btn mt-2 btn-primary float-end">Sign Up</button>
                            </div>
                            ...
                            <div class="sign-info">
                                <span class="dark-color d-inline-block line-height-2">Already Have Account ? <a href="sign-in.jsp">Log In</a></span>
