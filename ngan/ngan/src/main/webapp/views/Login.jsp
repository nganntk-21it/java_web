            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-6 bg-white pt-5 pt-5 pb-lg-0 pb-5">
                    <div class="sign-in-from">
                        ...
                        <input type="email" class="form-control mb-0" placeholder="Enter email" name="Yemail" required>
    
                       <label for="name"><b>Username</b></label>
                        <input type="text"  class="form-control mb-0" placeholder="Enter Username" name="uname" required>

                        <label for="pw"><b>Password</b></label>
                        <input type="password" class="form-control mb-0" placeholder="Enter Password" name="psw" required>
                         ...
                         <button class="btn btn-primary float-end" type="submit">Login</button>
                            ...
                            <div class="sign-info">
                                <span class="dark-color d-inline-block line-height-2">Don't have an account? <a href="sign-up.jsp">Sign up</a></span>
